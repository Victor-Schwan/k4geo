// copy of non-passive version:
//  difference: detector type flag not set:
//  intend for corresponding cooling and instrumentation
...
DECLARE_DETELEMENT(LumiCal_o1_v01_passive, create_detector)
